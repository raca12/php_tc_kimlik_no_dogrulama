...
if(@$_POST["gonder"])
{
					...
					$CuzdanSeri  = $_POST["CuzdanSeri"];
					$CuzdanNo  = $_POST["CuzdanNo"];

					
					
					include 'kutuphane/tckimlikno.php';
					$kontrol = new TCKimlikNoSinifi;
				    $sonuc= $kontrol->NufusCuzdaniDogrula($TCKimlikNo,$Ad,$Soyad,$DogumGun,$DogumAy,$DogumYil,$CuzdanSeri,$CuzdanNo);
...
<head>
<meta charset="utf-8">
<title>Nüfus Cüzdanı No Doğrulama</title>
...
<div class="form-group">
<label for="tid" class="col-sm-2 control-label">Cüzdan Seri</label>
<div class="col-sm-10">
<input type="text" class="form-control" name="CuzdanSeri" placeholder="Cüzdan Seri girin" value="<?php if(isset($_POST["CuzdanSeri"])){ echo $_POST["CuzdanSeri"];}?>" required />
</div>
</div>

<div class="form-group">
<label for="ck" class="col-sm-2 control-label">Cüzdan No</label>
<div class="col-sm-10">
<input type="text" class="form-control" name="CuzdanNo" placeholder="Cüzdan No girin" value="<?php if(isset($_POST["CuzdanNo"])){ echo $_POST["CuzdanNo"];}?>" required />
</div>
</div>
